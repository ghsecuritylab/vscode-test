...
set(DIR_OF_NRF52_CMAKE ${CMAKE_CURRENT_LIST_DIR})

macro(nRF52_toolchainSetup)
    include(${DIR_OF_NRF52_CMAKE}/arm-gcc-toolchain.cmake)
endmacro()
...
#             COMMAND ${TERMINAL} "${DIR_OF_NRF52_CMAKE}/runJLinkGDBServer-${NRF_TARGET}"
#             COMMAND ${TERMINAL} "${DIR_OF_NRF52_CMAKE}/runJLinkExe-${NRF_TARGET}"
#             COMMAND sleep 2s
#             COMMAND ${TERMINAL} "${DIR_OF_NRF52_CMAKE}/runJLinkRTTClient"
...
macro(nRF52_addBSP WITH_BLE_BTN WITH_ANT_BTN WITH_NFC)
    include_directories(
...
endmacro(nRF52_addNFC)

macro(nRF52_addBLEService NAME)
    include_directories(
